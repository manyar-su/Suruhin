  ...
  return (
    <div className="rounded-[28px] border border-slate-100 bg-white p-4 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#FF6500]">Mapbox live tracking</p>
      ...
      <div className="mt-4 flex items-center gap-2 rounded-2xl bg-slate-50 px-3 py-2 text-[11px] font-semibold text-[#082B5C]">
        ...
        <span>Tracking aktif hanya saat booking sedang berjalan. Rute, ETA, dan titik temu dihitung oleh Mapbox lalu berhenti otomatis saat selesai.</span>
      </div>
    </div>
  );
}
